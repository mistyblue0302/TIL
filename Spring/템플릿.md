...
jdbcContextWithStatementStrategy()는 JDBC의 일반적인 작업 흐름을 담고 있고, 다른 DAO에서도 사용 가능하다. jdbcContextWithStatementStrategy()를 UserDao 클래스 밖으로 독립시켜서 모든 DAO가 사용할 수 있게 해보자.
